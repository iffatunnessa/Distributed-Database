...
create or replace view viewsuppliers(sno,Sname,addre,Com,Pho) as
select Sup_ID,Supplier_Name,Address,Company,Phone from Suppliers;

create or replace view viewmedicine(mid,medname,pri,comname,batchno,expdate,mfgdate,typ) as
